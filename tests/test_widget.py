...
def test_get_date_with_valid_date(valid_date_string) -> None:
    assert get_date(valid_date_string) == "11.03.2024"


def test_get_date_with_another_valid_date(another_valid_date) -> None:
    assert get_date(another_valid_date) == "31.12.1999"


def test_get_date_with_invalid_date_string(invalid_date_string) -> None:
    assert get_date(invalid_date_string) == "Проверьте правильность ввода!"


def test_get_date_with_another_invalid_date_string(another_invalid_date_string) -> None:
    assert get_date(another_invalid_date_string) == "Проверьте правильность ввода!"


def  test_get_date_with_empty_date_string(empty_date_string) -> None:
